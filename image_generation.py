...
async def modify_prompt(
    ...
    default_style_from_settings = settings.get('default_style', 'off'); style_to_apply = default_style_from_settings
    ...
    job_details_dict = {
        ...
        "default_mp_size": mp_size_str if not is_img2img else "N/A", 
